...
//DATA ACCESS OBJECT de PersonaDTO (manejo de datos de una persona).
...
public class PersonaDaoJDBC  implements PersonaDao{
    ...
    public List<PersonaDTO> select() throws SQLException{
        ...
        /*
        retorna una lista con todos los objetos de tipo PersonaDTO disponibles
        en base de datos
         */
        Connection cn = null;
        ...
        try {
            ...
            while (rs.next()) {//mientras encuentre algo en bd seguira ejecutandose
                ...
                persona = new PersonaDTO(idPersona, nombre, apellido, email, telefono);//creacion de nuevo objeto persona apartir de los atributos obtenidos
    ...
    public int insert(PersonaDTO persona) throws SQLException{
        ...
        /*
        Recibe un objeto de Tipo PersonaDTO e ingresa la infomacion del objeto dentro de la bd
         */
        //objetos a utilizar
        Connection con = null;
    ...
    public int update(PersonaDTO persona) throws SQLException{
        ...
        List<PersonaDTO> personas = this.select();
         int registros = 0;
    ...
    public int delete(PersonaDTO persona) throws SQLException{
        ...
        if (existe) { //si el registro existe
            try {
                ...
                registros=stmt.executeUpdate();//ejecucion de update (tambien valido en delete)
